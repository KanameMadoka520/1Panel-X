...
func (a *WebsiteRouter) InitRouter(Router *gin.RouterGroup) {
	...
	baseApi := v2.ApiGroupApp.BaseApi
	{
		...
		websiteRouter.POST("/:id/waf/blocks", baseApi.LoadWafBlocks)
		...
		websiteRouter.GET("/:id/waf/rules", baseApi.GetWafCustomRules)
		websiteRouter.POST("/:id/waf/rules", baseApi.SaveWafCustomRule)
		websiteRouter.POST("/:id/waf/rules/del", baseApi.DeleteWafCustomRules)
		websiteRouter.POST("/:id/waf/rules/order", baseApi.ReorderWafCustomRules)
