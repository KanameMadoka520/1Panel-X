...
func TestFindCurrentAndLatestNginxModuleBuild(t *testing.T) {
	...
	module.Builds = []dto.NginxModuleBuild{
		{Hash: "old", Status: nginxModuleStatusReady, BuildMode: module.BuildMode, Target: target, BuiltAt: oldTime},
		{Hash: currentHash, Status: nginxModuleStatusReady, BuildMode: module.BuildMode, Target: target, BuiltAt: newTime},
	}
