...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            agentLimitHelper: '0 表示不限制智能体数量；数量不限不代表主机 CPU、内存、磁盘、端口或 Docker 容量无限。',
    ...
    setting: {
        ...
        addNode: '添加节点',
        nodePort: '节点端口',
        nodeEmpty: '暂无节点。添加节点后，在目标主机上完成注册即可。',
        nodeNamePlaceholder: '用于标识该节点的名称',
        nodeManageHelper:
            '将远程主机注册为节点。添加节点会签发一次性注册令牌；在目标主机上完成注册后，即可通过双向 TLS 上线。',
        nodeEnrollToken: '注册令牌',
        nodeEnrollTokenHelper: '该令牌为一次性、短时有效。请提供给目标主机以完成注册。请妥善保密，不要重复使用。',
        nodeTokenExpire: '过期时间',
        nodeDeleteHelper: '确定要移除节点“{0}”吗？此操作会撤销其访问权限。',
        nodeStatus_pending: '待注册',
        nodeStatus_enrolling: '注册中',
        ...
        brandGroup: '品牌与登录页',
        brandText: '品牌文字',
        brandTextHelper: '显示在 Logo 旁（最多 64 个字符，仅纯文本）',
        masterAlias: '主控别名',
        loginBgTypeLabel: '登录页背景类型',
        loginBgTypeImage: '图片',
        loginBgTypeColor: '纯色',
        loginBackgroundColor: '登录页背景色',
        loginBtnLinkColorLabel: '登录页按钮/链接色',
        loginWelcomeLabel: '登录页欢迎语',
        loginSubtitleLabel: '登录页副标题',
        copyrightLabel: '登录页版权信息',
        copyrightHelper: '显示在登录页底部（仅纯文本，最多 200 字符）',
        brandImages: '品牌图片',
        brandLogo: 'Logo（侧栏收起）',
        brandLogoWithText: '带文字 Logo（侧栏展开）',
        brandFavicon: '站点图标 Favicon',
        brandLoginImage: '登录页插图',
        brandLoginBgImage: '登录页背景图',
        brandUpload: '上传',
        brandImageHelper: '支持 PNG、JPEG、GIF、WEBP，最大 2 MB',
        brandFaviconHelper: '仅支持 PNG，最大 256 KB',
        brandImageTooLarge: '图片超过大小限制',
        brandImageBadType: '不支持的图片类型',
        panelPort: '面板端口',
        ...
        oauthConfigured: '已配置并授权',
        oauthUnconfigured: '未配置 OAuth 应用',
        oauthLegacyReconfigurationRequired: '需要迁移',
        oauthLegacyReconfigurationHelp: '检测到旧共享 OAuth 应用，请配置自己的应用并重新授权',
        oauthReauthorizationRequired: '需要重新授权',
        oauthReauthorizationHelp: 'OAuth 应用已配置，需要重新授权',
        oauthClientIdPlaceholder: '请输入新的客户端 ID',
        oauthClientIdKeepPlaceholder: '留空保留当前客户端 ID（{0}）',
        oauthSecretPlaceholder: '请输入客户端密钥',
        oauthSecretKeepHelper: '密钥不会回显，留空表示保留现有密钥',
        oauthRedirectPlaceholder: '请输入 OAuth 回调地址',
        oauthRedirectKeepHelper: '留空表示保留现有回调地址',
        oauthAuthorize: '开始授权',
        oauthReauthorize: '重新授权',
        oauthOpenAuthorization: '重新打开授权页',
        oauthAuthorizationResponse: '授权回调地址',
        oauthAuthorizationResponseHelper: '完成授权后，粘贴浏览器地址栏中的完整回调地址',
        oauthAuthorizationResponseRequired: '请先开始授权并粘贴完整回调地址',
        oauthInvalidAuthorizationResponse: '授权回调地址格式无效',
        oauthAuthorizationCompleted: '授权与连接验证已完成，请保存此备份账号',
        oauthCredentialsRequired: '请填写客户端 ID、客户端密钥和 OAuth 回调地址',
    ...
    website: {
        ...
        monitor: '监控',
        waf: 'WAF 防护',
        monitorRange24h: '近 24 小时',
        monitorRange7d: '近 7 天',
        monitorRange30d: '近 30 天',
        monitorPv: '访问量 PV',
        monitorUv: '独立访客 UV',
        monitorPeakUv: '每小时峰值 UV',
        monitorBytes: '流量',
        monitorTraffic: '访问趋势 (PV / UV)',
        monitorStatus: '状态码',
        monitorRank: '排行',
        monitorRegion: '地域',
        monitorRankKey: '取值',
        monitorHits: '次数',
        monitorNoData: '暂无数据',
        wafTip: 'Web 应用防火墙记录的攻击事件。当 WAF 网关开始防护该站点后，事件会显示在此处。',
        wafProtection: 'WAF 防护',
        wafProtected: '防护中',
        wafPending: '待验证',
        wafDisabled: '未启用',
        wafDetectionMode: '检测模式',
        wafBlockMode: '拦截模式',
        ...
        wafDefaultRules: '默认规则',
        wafDefaultRulesTip: '内置检测规则的开关。规则来自 OWASP CRS，开关真实作用于规则引擎。',
        wafGlobalDefaultRulesTip: '面板级默认检测策略；站点若设置了自己的策略，则以站点为准。',
        wafRulesInherited: '跟随全局',
        wafRulesInheritedTip: '当前显示的是全局策略，本站点未单独设置。',
        wafRulesOverride: '改为本站点单独设置',
        wafRulesOwn: '本站点单独设置',
        wafRulesFollowGlobal: '改回跟随全局',
        wafRuleSqli: 'SQL 注入防御',
        wafRuleSqliTip: '识别请求中的 SQL 注入并拦截。关闭后仅停用 SQL 注入相关规则，其余防护不受影响。',
        wafRuleXss: 'XSS 防御',
        wafRuleXssTip: '识别请求中的 XSS 并拦截。关闭后仅停用 XSS 相关规则，其余防护不受影响。',
        wafRuleStrict: '严格模式',
        wafRuleStrictTip: '使用更严格的规则来校验请求，检出率更高，误报也更多；建议先用检测模式观察一段时间。',
        wafRuleMethods: 'HTTP 方法过滤',
        wafRuleMethodsTip: '只允许勾选的请求方法访问，未勾选的方法一律拒绝。不启用则沿用规则集自带的默认方法集合。',
        wafRuleMethodsEnable: '启用方法白名单',
        wafUpload: '文件上传限制',
        wafUploadTip: '仅作用于本网站。总开关关闭时，下面的规则保留但不生效。',
        wafUploadTitle: '禁止上传的文件扩展名',
        wafUploadRule: '规则',
        wafUploadFuzzy:
            '规则为模糊匹配：文件名里只要出现这段文字就会被拒。好处是 shell.php.jpg 这种双扩展名一并挡掉；代价是写 sh 会连 shanghai.jpg 也挡掉，请按需取舍。',
        wafUploadOn: '已启用',
        wafUploadOnButEmpty: '已启用，但没有生效中的规则——不会拦下任何上传。',
        wafUploadOff: '已关闭。规则保留，随时可以再打开。',
        wafBans: '封锁记录',
        ...
        wafListsTip:
            '拒绝名单命中即返回 403；放行名单命中则跳过规则引擎检测、封禁与频率限制，但仍经加固反代转发。同时命中时以拒绝为准。',
        wafListDeny: '黑名单',
        wafListAllow: '白名单',
        wafListDenyHint: '命中的请求直接返回 403。',
        wafListAllowHint: '命中的请求跳过规则引擎、封禁与频率限制，但仍经加固反代转发。',
        wafListIpGroup: 'IP 组',
        wafListGroupHint: '把常用的 IP / 网段归为一组，供名单条目引用；被引用的组不能删除。',
        wafListGroupName: '组名',
        wafListGroupMembers: '成员（每行一个 IP 或 CIDR）',
        wafListGroupTitle: 'IP 组',
        wafListEntryTitle: '名单条目',
        wafListWhich: '归属名单',
        wafListTarget: '匹配对象',
        wafListPattern: '规则',
        wafListRemark: '备注',
        wafListMatch: '匹配方式',
        wafListMatchContains: '包含',
        wafListMatchPrefix: '前缀',
        ...
        wafRulesCustomOrder: '顺序',
        wafRulesCustomOrderHint: '自上而下匹配，第一条命中的拦截/放行规则说了算；仅记录的规则不会挡住后面的规则。',
        wafRulesCustomTitle: '自定义规则',
        wafRulesCustomName: '名称',
        wafRulesCustomNameFixed:
            '名称创建后不可修改：已经写下的拦截记录里记的是旧名字，改了就会指向一条不再叫这个名字的规则。',
        wafRulesCustomRule: '规则',
        wafRulesCustomObject: '匹配对象',
        wafRulesCustomCondition: '匹配条件',
        wafRulesCustomValue: '匹配内容',
        wafRulesOp_eq: '等于',
        wafRulesOp_ne: '不等于',
        wafRulesOp_contains: '包含',
        wafRulesOp_notContains: '不包含',
        wafRulesOp_regex: '正则表达式',
        wafRulesField_url: 'URL',
        wafRulesCustomUnnamed: '（未命名）',
        wafRulesCustomBroken: '无法读取',
        wafRulesCustomAction: '动作',
        wafRulesCustomConditions: '条件',
        wafRulesCustomAndHint: '所有条件同时满足才算命中。',
        wafRulesCustomAddCondition: '添加条件',
        wafRulesCustomNegate: '取反',
        wafRulesCustomNot: '不',
        wafRulesCustomFieldName: '名称',
        wafRulesActionDeny: '拦截',
        wafRulesActionAllow: '放行',
        wafRulesActionLog: '仅记录',
        ...
        wafBlocks: '拦截记录',
        wafBlocksTip:
            '网关自己做出的判断。规则集命中在上面的攻击事件里，这里是黑白名单、自定义规则、地区限制、频率限制、封禁、验证、未知域名、请求体超限。',
        wafBlockTip: '每分钟从网关的执行日志摄入一次，可能有一分钟左右延迟。',
        wafBlockAllKinds: '全部类型',
        wafBlockKind: '类型',
        wafBlockAction: '结果',
        wafBlockRule: '命中规则',
        wafAction_blocked: '已拦截',
        wafAction_detected: '仅记录',
        wafAction_challenged: '要求验证',
        wafAction_banned: '已封禁',
        wafAction_released: '已解封',
        wafRulesField_ip: '客户端 IP',
        wafRulesField_host: '域名',
        wafRulesField_method: '请求方法',
        wafRulesField_uri: '完整 URI',
        wafRulesField_path: '路径',
        wafRulesField_query: '查询串',
        wafRulesField_ua: 'User-Agent',
        wafRulesField_referer: 'Referer',
        wafRulesField_header: '请求头',
        wafRulesField_cookie: 'Cookie',
        wafListMatchIp: 'IP / 网段',
        wafRateLimit: '频率限制',
        wafRateLimitTip: '按来源 IP 统计请求频率，超过阈值即临时封禁该 IP。本站点设置会覆盖同类型的全局设置。',
        wafGlobalRateLimitTip:
            '全局频率限制对所有启用 WAF 的网站生效；站点如设置了同类型限制则以站点为准。攻击频率限制由网关统一统计，只能在此设置。',
        wafRlGatewayWide: '网关级',
        wafRl_access: '访问频率限制',
        wafRl_url: 'URL 频率限制',
        wafRl_notfound: '404 频率限制',
        wafRl_attack: '攻击频率限制',
        wafRlOff_access: '未启用：不统计访问频率。',
        wafRlOff_url: '未启用：不单独统计单个 URL 的请求频率。',
        wafRlOff_notfound: '未启用：不统计 404 响应频率。',
        wafRlOff_attack: '未启用：不统计命中规则的攻击频率。',
        wafRlSummary: '{0} 秒内达到 {1} 次，封禁该 IP {2} 秒。',
        wafRlSummaryNoBan: '{0} 秒内达到 {1} 次即记录，但不封禁（仅观察）。',
        wafRlMode: '模式',
        wafRlModeGlobal: '全局模式',
        wafRlModeUrl: 'URL 模式',
        wafRlPeriod: '周期（秒）',
        wafRlThreshold: '阈值（次）',
        wafRlBan: '封禁时长（秒）',
        ...
        wafDenyList: '拒绝名单',
        wafDenyListTip: '命中的来源在检测与拦截两种模式下都直接返回 403（优先于规则引擎）。',
        wafAllowList: '放行名单',
        wafAllowListTip: '命中的来源跳过规则引擎检测，仍经加固反代转发；留空表示不放行任何来源。',
        wafSourceIp: '来源 IP',
        wafRule: '命中规则',
        wafCategory: '类别',
        wafSeverity: '严重度',
    ...
    xpack: {
        ...
        vm: {
            ...
            currentSnapshot: '当前',
            snapshotEmpty: '暂无快照',
            snapshotOperationHelper: '当前正在使用的快照不允许删除；仅当虚拟机处于已关机状态时才允许恢复快照。',
