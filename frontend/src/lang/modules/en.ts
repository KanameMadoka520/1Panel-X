...
const message = {
    ...
    setting: {
        ...
        title: 'Panel alias',
        brandGroup: 'Brand & Login',
        brandText: 'Brand text',
        brandTextHelper: 'Shown next to the logo (max 64 characters, plain text only)',
        masterAlias: 'Master alias',
        loginBgTypeLabel: 'Login background type',
        loginBgTypeImage: 'Image',
        loginBgTypeColor: 'Color',
        loginBackgroundColor: 'Login background color',
        loginBtnLinkColorLabel: 'Login button / link color',
        loginWelcomeLabel: 'Login welcome text',
        loginSubtitleLabel: 'Login subtitle',
        copyrightLabel: 'Login copyright',
        copyrightHelper: 'Shown at the bottom of the login page (plain text only, max 200 characters)',
        brandImages: 'Brand images',
        brandLogo: 'Logo (collapsed sidebar)',
        brandLogoWithText: 'Logo with text (expanded sidebar)',
        brandFavicon: 'Favicon',
        brandLoginImage: 'Login illustration',
        brandLoginBgImage: 'Login background image',
        brandUpload: 'Upload',
        brandImageHelper: 'PNG, JPEG, GIF, or WEBP up to 2 MB',
        brandFaviconHelper: 'PNG only, up to 256 KB',
        brandImageTooLarge: 'The image exceeds the size limit',
        brandImageBadType: 'Unsupported image type',
        ...
        oauthConfigured: 'Configured and authorized',
        oauthUnconfigured: 'OAuth application not configured',
        oauthLegacyReconfigurationRequired: 'Migration required',
        oauthLegacyReconfigurationHelp:
            'A legacy shared OAuth application was detected. Configure your own application and authorize again.',
        oauthReauthorizationRequired: 'Authorization required',
        oauthReauthorizationHelp: 'The OAuth application is configured and must be authorized again.',
        oauthClientIdPlaceholder: 'Enter a new client ID',
        oauthClientIdKeepPlaceholder: 'Leave blank to keep the current client ID ({0})',
        oauthSecretPlaceholder: 'Enter the client secret',
        oauthSecretKeepHelper: 'The secret is never displayed. Leave it blank to keep the existing secret.',
        oauthRedirectPlaceholder: 'Enter the OAuth callback URL',
        oauthRedirectKeepHelper: 'Leave it blank to keep the existing callback URL.',
        oauthAuthorize: 'Start authorization',
        oauthReauthorize: 'Authorize again',
        oauthOpenAuthorization: 'Open authorization page again',
        oauthAuthorizationResponse: 'Authorization callback URL',
        oauthAuthorizationResponseHelper:
            'After authorization finishes, paste the complete callback URL from the browser address bar.',
        oauthAuthorizationResponseRequired: 'Start authorization and paste the complete callback URL first.',
        oauthInvalidAuthorizationResponse: 'The authorization callback URL is invalid.',
        oauthAuthorizationCompleted: 'Authorization and connection verification completed. Save this backup account.',
        oauthCredentialsRequired: 'Enter the client ID, client secret, and OAuth callback URL.',
        oauthAuthorizationRequired: 'Complete OAuth authorization first.',
        oauthSessionExpired:
    ...
    website: {
        ...
        monitor: 'Monitor',
        waf: 'WAF',
        monitorRange24h: 'Last 24h',
        monitorRange7d: 'Last 7 days',
        monitorRange30d: 'Last 30 days',
        monitorPv: 'PV',
        monitorUv: 'UV',
        monitorPeakUv: 'Peak UV / hour',
        monitorBytes: 'Traffic',
        monitorTraffic: 'Traffic (PV / UV)',
        monitorStatus: 'Status codes',
        monitorRank: 'Rankings',
        monitorRegion: 'Region',
        monitorRankKey: 'Value',
        monitorHits: 'Hits',
        monitorNoData: 'No data yet',
        wafTip: 'Attack events recorded by the web application firewall. Events appear here once the WAF gateway is protecting this site.',
        wafProtection: 'WAF protection',
        wafProtected: 'Protected',
        wafPending: 'Pending verification',
        wafDisabled: 'Disabled',
        wafDetectionMode: 'Detection mode',
        wafBlockMode: 'Block mode',
        ...
        wafModeInheritWith: 'Inherit global ({0})',
        wafGlobalSettings: 'Global defaults',
        ...
        wafRulesCustomOrder: 'Order',
        wafRulesCustomOrderHint:
            'Matched top to bottom; the first block or allow rule that fires decides. A log-only rule does not stop the rules below it.',
        wafRulesCustomTitle: 'Custom rule',
        wafRulesCustomName: 'Name',
        wafRulesCustomNameFixed:
            'The name is fixed after creation: enforcement records already written carry the old one, and changing it would leave them pointing at a rule that no longer answers to that name.',
        wafRulesCustomRule: 'Rule',
        wafRulesCustomObject: 'Match object',
        wafRulesCustomCondition: 'Condition',
        wafRulesCustomValue: 'Value',
        wafRulesOp_eq: 'Equals',
        wafRulesOp_ne: 'Does not equal',
        wafRulesOp_contains: 'Contains',
        wafRulesOp_notContains: 'Does not contain',
        wafRulesOp_regex: 'Regular expression',
        wafRulesField_url: 'URL',
        wafRulesCustomUnnamed: '(unnamed)',
        wafRulesCustomBroken: 'Unreadable',
        wafRulesCustomAction: 'Action',
        wafRulesCustomConditions: 'Conditions',
        wafRulesCustomAndHint: 'The rule fires only when every condition holds.',
        wafRulesCustomAddCondition: 'Add condition',
        wafRulesCustomNegate: 'Negate',
        wafRulesCustomNot: 'not',
        wafRulesCustomFieldName: 'Name',
        wafRulesActionDeny: 'Block',
        wafRulesActionAllow: 'Allow',
        wafRulesActionLog: 'Log only',
        wafRulesActionDenyHint: 'Answers 403; the request never reaches the origin.',
        wafRulesActionAllowHint:
        ...
        wafBlocks: 'Enforcement records',
        wafBlocksTip:
            'Decisions the gateway made on its own. Rule-set hits are in the attack events above; these are the lists, custom rules, region control, frequency limits, bans, challenges, unknown hosts and oversize bodies.',
        wafBlockTip: 'Ingested from the gateway once a minute, so there can be about a minute of delay.',
        wafBlockAllKinds: 'All kinds',
        wafBlockKind: 'Kind',
        wafBlockAction: 'Outcome',
        wafBlockRule: 'Rule',
        wafAction_blocked: 'Blocked',
        wafAction_detected: 'Recorded',
        wafAction_challenged: 'Challenged',
        wafAction_banned: 'Banned',
        wafAction_released: 'Released',
        wafRulesField_ip: 'Client IP',
        wafRulesField_host: 'Host',
        wafRulesField_method: 'Method',
        wafRulesField_uri: 'Full URI',
        wafRulesField_path: 'Path',
        wafRulesField_query: 'Query string',
        wafRulesField_ua: 'User-Agent',
        wafRulesField_referer: 'Referer',
        wafRulesField_header: 'Header',
        wafRulesField_cookie: 'Cookie',
        ...
        wafGlobalRateLimitTip:
            'Global limits apply to every WAF-enabled site; a site that sets the same kind wins. The attack limit is counted gateway-wide and can only be set here.',
        wafRlGatewayWide: 'Gateway-wide',
        wafRl_access: 'Request frequency',
        wafRl_url: 'Per-URL frequency',
        wafRl_notfound: '404 frequency',
        wafRl_attack: 'Attack frequency',
        wafRlOff_access: 'Off: request frequency is not counted.',
        wafRlOff_url: 'Off: per-URL request frequency is not counted separately.',
        wafRlOff_notfound: 'Off: 404 responses are not counted.',
        wafRlOff_attack: 'Off: rule matches are not counted.',
        wafRlSummary: '{1} within {0} seconds bans the address for {2} seconds.',
        wafRlSummaryNoBan: '{1} within {0} seconds is recorded but not banned (observe only).',
        wafRlMode: 'Mode',
        wafRlModeGlobal: 'All requests',
        wafRlModeUrl: 'Per URL',
        wafRlPeriod: 'Window (s)',
        wafRlThreshold: 'Threshold',
        wafRlBan: 'Ban duration (s)',
        ...
        wafAction: 'Action',
        wafBlocked: 'Blocked',
        wafDetected: 'Detected',
        wafCategoryAll: 'All categories',
